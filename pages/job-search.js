...
export default function JobSearch() {
  return (
    <div className="">
      ...
      <Header />
      {/* <img src="hamza.png"/> */}
      <div className="grid grid-rows-3 grid-cols-1 md:grid-cols-4 xl:grid-cols-5 bg-primary py-9 px-4 gap-8 font-medium order-1">
        <div className="hidden md:block" />
        <div className="hidden md:block" />
        <div className="justify-center align-middle text-2xl text-center">
          Find a job
        </div>
        <div className="hidden md:block" />
        <div className="hidden md:block" />
