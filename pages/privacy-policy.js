        ...
        <div className="px-[8px] text-2xl break-words">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Charmed Recruitment LTD, 18 Fox
                Street, PR12AB.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Charmed Recruitment,
                accessible from{" "}
                <Link
                  href="www.charmedrecruitment.co.uk"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  <a>www.charmedrecruitment.co.uk</a>
                </Link>
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            <Link
              ...
              rel="noreferrer"
            >
              <a>Cookies by PrivacyPolicies Generator</a>
            </Link>
            .
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <Link
                  href="http://www.charmedrecruitment.co.uk/contact-us"
                  target="_blank"
                  rel="external nofollow noopener"
                >
                  <a className="break-words">
                    http://www.charmedrecruitment.co.uk/contact-us
                  </a>
                </Link>
              </p>
            </li>
